...
<head>
  ...
  <title>Sneakcare | Dashboard</title>
...
<div class="wrapper">
  ...
  <!-- Main Sidebar Container -->
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <img src="{{ asset('dist/backend/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
         <div class="image">
            <img src="{{ asset('dist/backend/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
         </div>
         <div class="info">
            <a href="#" class="d-block">Admin Sneakcare</a>
         </div>
      </div>
   ...
   <footer class="main-footer">
      ...
      <strong>Sneakcare Dashboard</strong>
   </footer>
  ...
  <!-- jQuery UI 1.11.4 -->
  <script src="{{ asset('dist/backend/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
  ...
  <!-- AdminLTE App -->
  <script src="{{ asset('dist/backend/js/adminlte.js') }}"></script>
